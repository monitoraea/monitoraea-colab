...
const tools = {
  ...
  NetworkHomeCNE: lazy(() => import('./NetworkHomeCNE')),
  NetworkHomeIniciativas: lazy(() => import('./NetworkHomeIniciativas')),
  CIEAHome: lazy(() => import('./CIEAHome')),
  PPEAHome: lazy(() => import('./PPEAHome')),
  CNEHome: lazy(() => import('./CNEHome')),
  IniciativasHome: lazy(() => import('./IniciativasHome')),
  ECNews: lazy(() => import('./ECNews')),
  ECHome: lazy(() => import('./ECHome')),
  CMS: lazy(() => import('./CMS')),
