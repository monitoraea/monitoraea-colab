...
exports.TEST_TYPES = {
    [TYPES.INT]: (data) =>          ![null, undefined].includes(data) && data !== '',
    [TYPES.TEXT]: (data) =>         ![null, undefined].includes(data) && data.length > 0,
    [TYPES.TEXT_M]: (data) =>       ![null, undefined].includes(data) && data.length > 0,
    // [TYPES.TEXT_FILE]: (data) =>    ![null, undefined].includes(data) && data.length > 0,
    [TYPES.SEL_S]: (data) =>        ![null, undefined].includes(data) && data !== 'none',
    [TYPES.SEL_M]: (data) =>        ![null, undefined].includes(data) && Array.isArray(data) && data.length > 0,
    [TYPES.SEL_SO]: (data) =>       ![null, undefined].includes(data) && (data !== 'none' || (data.other && data.other.length > 0)) ,
    [TYPES.SEL_MO]: (data) =>       ![null, undefined].includes(data) && ((data.items && data.items.length) || (data.other && data.other.length > 0)),
    [TYPES.ITEMS]: (data) =>        ![null, undefined].includes(data) && data.length > 0,
    [TYPES.SN]: (data) =>           ![null, undefined].includes(data) && data !== 'none',
}
