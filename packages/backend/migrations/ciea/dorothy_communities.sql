...
VALUES(601, false, NULL, '{"title": "Guardiões do CIEA", "tools": [{"id": 12}, {"id": 4}, {"id": 1}], "includes": [], "perspective": 3}'::jsonb, '2024-05-20 11:56:13.117', '2024-05-20 11:56:13.118', 'adm', 'adm                 ', NULL);

INSERT INTO public.dorothy_communities
(id, members_only, descriptor_url, descriptor_json, "createdAt", "updatedAt", alias, "type", config)
VALUES(302, false, NULL, '{"title": "Guardiões do MonitoraEA", "tools": [{"id": 12}, {"id": 4}, {"id": 1}], "includes": [], "perspective": 1}'::jsonb, '2024-05-20 11:56:13.117', '2024-05-20 11:56:13.118', 'adm', 'adm                 ', NULL);
...
SET members_only=false, descriptor_url=NULL, descriptor_json='{"title": "Guardiões do PPPZCM", "tools": [{"id": 14, "group": "painel"}, {"id": 15, "group": "painel"}, {"id": 12}, {"id": 4}, {"id": 1}], "groups": [{"id": "painel", "icon": "chart", "title": "visualizações"}], "includes": [], "perspective": 2}'::jsonb, "createdAt"='2021-06-04 11:57:36.469', "updatedAt"='2021-06-04 11:57:36.469', alias='adm', "type"='adm                 ', config=NULL
WHERE id=1;
